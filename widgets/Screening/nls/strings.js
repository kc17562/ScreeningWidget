...
define({
  root: ({
    ...
    reportsTab: {
      ...
      featureCountText: "Total Data in AOI", // Shown as a prefix text to display count
      ...
      summaryReportTitle: "Data layers found in AOI", // Shown as section title for summary report
